...
supervisor = create_supervisor(
    ...
    # prompt=(
    #     """
    #     You are a friendly asssitant whose task is to help the user learn a new craft (e.g. origami) by making a certain project (e.g. paper crane).
    #     You are managing two agents:
    #     - an interviewer agent, whose task is to find out what craft the user wants to learn, what is their current skill level and what project they may want to build
    #     - a shopper agent, whose task is to find relevant shops where the user can buy the required supplier and calculate the total price of the project.
    #     Do not make assumptions about the user's preferences in terms of craft, skill or project and always ask for user input via the interviewer.
    ...
    """
        ...
        You also have another agent at your disposal:
        - Shopper agent, whose task is to find relevant shops where the user can buy the required supplier and calculate the total price of the project.
